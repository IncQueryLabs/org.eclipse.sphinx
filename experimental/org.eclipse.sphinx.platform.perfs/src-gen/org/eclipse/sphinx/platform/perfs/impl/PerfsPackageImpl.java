...
public class PerfsPackageImpl extends EPackageImpl implements PerfsPackage
{
   ...
   * 
   * <p>This method is used to initialize {@link PerfsPackage#eINSTANCE} when that field is accessed.
  ...
  {
    if (isInited) return (PerfsPackage)EPackage.Registry.INSTANCE.getEPackage(PerfsPackage.eNS_URI);

    // Obtain or create and register package
    PerfsPackageImpl thePerfsPackage = (PerfsPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof PerfsPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new PerfsPackageImpl());
  ...
  public void initializePackageContents()
  {
    ...
    initEReference(getPerformanceStats_Measurements(), this.getMeasurement(), null, "measurements", null, 0, -1, PerformanceStats.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getMeasurement_Count(), theEcorePackage.getEInt(), "count", null, 0, 1, Measurement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getMeasurement_Total(), theEcorePackage.getELong(), "total", null, 0, 1, Measurement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getMeasurement_Running(), theEcorePackage.getEBoolean(), "running", null, 0, 1, Measurement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getMeasurement_StartTime(), theEcorePackage.getELong(), "startTime", null, 0, 1, Measurement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getMeasurement_AverageTime(), theEcorePackage.getELong(), "averageTime", null, 0, 1, Measurement.class, IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    initEReference(getMeasurement_Children(), this.getMeasurement(), null, "children", null, 0, -1, Measurement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
