 ...
 * @generated
 */
public class PerfsSwitch<T> extends Switch<T> {
	/**
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Performance Stats</em>'. <!-- begin-user-doc
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Measurement</em>'. <!-- begin-user-doc -->
	 * This implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *            the target of the switch.
