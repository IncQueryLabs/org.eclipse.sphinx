...
public class PerfsAdapterFactory extends AdapterFactoryImpl
{
   ...
   * @generated
   */
  protected PerfsSwitch<Adapter> modelSwitch =
    new PerfsSwitch<Adapter>()
    {
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.eclipse.sphinx.platform.perfs.PerformanceStats <em>Performance Stats</em>}'.
   * <!-- begin-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.eclipse.sphinx.platform.perfs.Measurement <em>Measurement</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
