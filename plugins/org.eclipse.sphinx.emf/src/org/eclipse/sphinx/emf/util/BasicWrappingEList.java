...
/**
 * An extensible delegating list implementation with a wrapping and unwrapping object support.
 */
public class BasicWrappingEList<E extends IWrapper<T>, T> extends AbstractEList<E> implements Cloneable, Serializable {
	 ...
	 */
	protected E wrap(T object) throws SecurityException, NoSuchMethodException, InstantiationException, IllegalAccessException,
