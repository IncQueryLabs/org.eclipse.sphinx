...
public class ParametersByNameMatcher extends BaseMatcher<ParametersByNameMatch> {
   ...
   */
  @Deprecated
  public DeltaMonitor<ParametersByNameMatch> newFilteredDeltaMonitor(final boolean fillAtStart, final Parameter pParam, final String pName) {
    return rawNewFilteredDeltaMonitor(fillAtStart, new Object[]{pParam, pName});
  }
  ...
  public Set<Parameter> getAllValuesOfparam(final String pName) {
    return rawAccumulateAllValuesOfparam(new Object[]{null, pName});
  }
  ...
  public Set<String> getAllValuesOfname(final Parameter pParam) {
    return rawAccumulateAllValuesOfname(new Object[]{pParam, null});
  }
