...
public class PortsMatcher extends BaseMatcher<PortsMatch> {
   ...
   */
  @Deprecated
  public DeltaMonitor<PortsMatch> newFilteredDeltaMonitor(final boolean fillAtStart, final Port pPort) {
    return rawNewFilteredDeltaMonitor(fillAtStart, new Object[]{pPort});
  }
