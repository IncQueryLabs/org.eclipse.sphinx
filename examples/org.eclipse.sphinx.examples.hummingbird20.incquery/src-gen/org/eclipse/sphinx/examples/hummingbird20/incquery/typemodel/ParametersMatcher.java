...
/**
 * Generated pattern matcher API of the org.eclipse.sphinx.examples.hummingbird20.incquery.typemodel.parameters pattern,
 ...
 * <p>Original source:
 * <code><pre>
 * pattern parameters(param : Parameter){
 * 	Parameter(param);
 * }
 * </pre></code>
 * 
...
public class ParametersMatcher extends BaseMatcher<ParametersMatch> {
   ...
   * 
   */
  public Collection<ParametersMatch> getAllMatches(final Parameter pParam) {
   ...
   * 
   */
  public ParametersMatch getOneArbitraryMatch(final Parameter pParam) {
   ...
   * 
   */
  public void forEachMatch(final Parameter pParam, final IMatchProcessor<? super ParametersMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final Parameter pParam, final IMatchProcessor<? super ParametersMatch> processor) {
