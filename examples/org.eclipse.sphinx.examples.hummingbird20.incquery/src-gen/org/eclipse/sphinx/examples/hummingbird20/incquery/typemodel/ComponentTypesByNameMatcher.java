...
public class ComponentTypesByNameMatcher extends BaseMatcher<ComponentTypesByNameMatch> {
   ...
   */
  @Deprecated
  public DeltaMonitor<ComponentTypesByNameMatch> newFilteredDeltaMonitor(final boolean fillAtStart, final ComponentType pComponentType, final String pName) {
    return rawNewFilteredDeltaMonitor(fillAtStart, new Object[]{pComponentType, pName});
  }
  ...
  public Set<ComponentType> getAllValuesOfcomponentType(final String pName) {
    return rawAccumulateAllValuesOfcomponentType(new Object[]{null, pName});
  }
  ...
  public Set<String> getAllValuesOfname(final ComponentType pComponentType) {
    return rawAccumulateAllValuesOfname(new Object[]{pComponentType, null});
  }
