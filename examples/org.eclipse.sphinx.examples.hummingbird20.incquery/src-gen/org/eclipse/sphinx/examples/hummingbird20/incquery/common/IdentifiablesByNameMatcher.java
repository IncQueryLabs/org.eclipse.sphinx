...
/**
 * Generated pattern matcher API of the org.eclipse.sphinx.examples.hummingbird20.incquery.common.identifiablesByName pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(IncQueryEngine)},
 * e.g. in conjunction with {@link IncQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link IdentifiablesByNameMatch}.
 * 
 * <p>Original source:
 * <code><pre>
 * pattern identifiablesByName(identifiable : Identifiable, name) {
 * 	Identifiable.name(identifiable, name);
 * }
 * </pre></code>
 * 
 * @see IdentifiablesByNameMatch
 * @see IdentifiablesByNameProcessor
 * @see IdentifiablesByNameQuerySpecification
 * 
 */
...
public class IdentifiablesByNameMatcher extends BaseMatcher<IdentifiablesByNameMatch> {
   ...
   * 
   */
  public static IdentifiablesByNameMatcher on(final IncQueryEngine engine) throws IncQueryException {
    // check if matcher already exists
    IdentifiablesByNameMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
    	matcher = new IdentifiablesByNameMatcher(engine);
  ...
  private final static Logger LOGGER = IncQueryLoggingUtil.getLogger(IdentifiablesByNameMatcher.class);
   ...
   */
  @Deprecated
  public IdentifiablesByNameMatcher(final Notifier emfRoot) throws IncQueryException {
   ...
   */
  @Deprecated
  public IdentifiablesByNameMatcher(final IncQueryEngine engine) throws IncQueryException {
   ...
   * @return matches represented as a IdentifiablesByNameMatch object.
   * 
   */
  public Collection<IdentifiablesByNameMatch> getAllMatches(final Identifiable pIdentifiable, final String pName) {
    return rawGetAllMatches(new Object[]{pIdentifiable, pName});
  }
   ...
   * @param pIdentifiable the fixed value of pattern parameter identifiable, or null if not bound.
   * @param pName the fixed value of pattern parameter name, or null if not bound.
   * @return a match represented as a IdentifiablesByNameMatch object, or null if no match is found.
   * 
   */
  public IdentifiablesByNameMatch getOneArbitraryMatch(final Identifiable pIdentifiable, final String pName) {
    return rawGetOneArbitraryMatch(new Object[]{pIdentifiable, pName});
  }
   ...
   * 
   */
  public boolean hasMatch(final Identifiable pIdentifiable, final String pName) {
    return rawHasMatch(new Object[]{pIdentifiable, pName});
  }
   ...
   * 
   */
  public int countMatches(final Identifiable pIdentifiable, final String pName) {
    return rawCountMatches(new Object[]{pIdentifiable, pName});
  }
   ...
   * 
   */
  public void forEachMatch(final Identifiable pIdentifiable, final String pName, final IMatchProcessor<? super IdentifiablesByNameMatch> processor) {
    rawForEachMatch(new Object[]{pIdentifiable, pName}, processor);
  }
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final Identifiable pIdentifiable, final String pName, final IMatchProcessor<? super IdentifiablesByNameMatch> processor) {
    return rawForOneArbitraryMatch(new Object[]{pIdentifiable, pName}, processor);
  }
   ...
   * 
   */
  public Set<Identifiable> getAllValuesOfidentifiable(final IdentifiablesByNameMatch partialMatch) {
   ...
   * 
   */
  public Set<String> getAllValuesOfname(final IdentifiablesByNameMatch partialMatch) {
