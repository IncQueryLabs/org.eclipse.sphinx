...
/**
 * Generated pattern matcher API of the org.eclipse.sphinx.examples.hummingbird20.incquery.common.identifiables pattern,
...
public class IdentifiablesMatcher extends BaseMatcher<IdentifiablesMatch> {
   ...
   */
  @Deprecated
  public DeltaMonitor<IdentifiablesMatch> newFilteredDeltaMonitor(final boolean fillAtStart, final Identifiable pIdentifiable) {
    return rawNewFilteredDeltaMonitor(fillAtStart, new Object[]{pIdentifiable});
  }
  ...
  protected IdentifiablesMatch tupleToMatch(final Tuple t) {
    try {
      return IdentifiablesMatch.newMatch((org.eclipse.sphinx.examples.hummingbird20.common.Identifiable) t.get(POSITION_IDENTIFIABLE));
  ...
  protected IdentifiablesMatch arrayToMatch(final Object[] match) {
    try {
      return IdentifiablesMatch.newMatch((org.eclipse.sphinx.examples.hummingbird20.common.Identifiable) match[POSITION_IDENTIFIABLE]);
    } catch(ClassCastException e) {
  ...
  protected IdentifiablesMatch arrayToMatchMutable(final Object[] match) {
    try {
      return IdentifiablesMatch.newMutableMatch((org.eclipse.sphinx.examples.hummingbird20.common.Identifiable) match[POSITION_IDENTIFIABLE]);
    } catch(ClassCastException e) {
      LOGGER.error("Element(s) in array not properly typed!",e);
      return null;
    }
