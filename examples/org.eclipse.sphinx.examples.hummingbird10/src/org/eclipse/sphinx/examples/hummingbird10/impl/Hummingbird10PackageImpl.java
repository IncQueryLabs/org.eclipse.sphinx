...
public class Hummingbird10PackageImpl extends EPackageImpl implements Hummingbird10Package {
	 ...
	 * 
	 * <p>This method is used to initialize {@link Hummingbird10Package#eINSTANCE} when that field is accessed.
	...
	public static Hummingbird10Package init() {
		if (isInited) return (Hummingbird10Package)EPackage.Registry.INSTANCE.getEPackage(Hummingbird10Package.eNS_URI);

		// Obtain or create and register package
		Hummingbird10PackageImpl theHummingbird10Package = (Hummingbird10PackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Hummingbird10PackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Hummingbird10PackageImpl());
	...
	public void initializePackageContents() {
		...
		initEAttribute(getComponent_Name(), ecorePackage.getEString(), "name", "", 1, 1, Component.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$ //$NON-NLS-2$
		...
		initEReference(getComponent_ProvidedInterfaces(), this.getInterface(), this.getInterface_ProvidingComponents(), "providedInterfaces", null, 0, -1, Component.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		...
		initEAttribute(getApplication_Name(), ecorePackage.getEString(), "name", null, 1, 1, Application.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		...
		initEReference(getApplication_Interfaces(), this.getInterface(), null, "interfaces", null, 0, -1, Application.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$

		initEClass(connectionEClass, Connection.class, "Connection", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
		initEReference(getConnection_RequiredInterface(), this.getInterface(), null, "requiredInterface", null, 1, 1, Connection.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		...
		initEAttribute(getConnection_Name(), ecorePackage.getEString(), "name", null, 1, 1, Connection.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$

		initEClass(interfaceEClass, Interface.class, "Interface", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
		initEAttribute(getInterface_Name(), ecorePackage.getEString(), "name", null, 1, 1, Interface.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		initEReference(getInterface_ProvidingComponents(), this.getComponent(), this.getComponent_ProvidedInterfaces(), "providingComponents", null, 0, -1, Interface.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
	...
	protected void createEcoreAnnotations() {
		...
		addAnnotation
		  (connectionEClass, 
		   source, 
		   new String[] {
			 "constraints", "validateInterfacesImplementedByTargetComponent" //$NON-NLS-1$ //$NON-NLS-2$
		   });
	}
