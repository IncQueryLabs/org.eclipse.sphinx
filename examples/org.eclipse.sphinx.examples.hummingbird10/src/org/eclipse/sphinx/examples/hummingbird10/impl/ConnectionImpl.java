 ...
 * <ul>
 *   <li>{@link org.eclipse.sphinx.examples.hummingbird10.impl.ConnectionImpl#getRequiredInterface <em>Required Interface</em>}</li>
 *   <li>{@link org.eclipse.sphinx.examples.hummingbird10.impl.ConnectionImpl#getTargetComponent <em>Target Component</em>}</li>
 *   <li>{@link org.eclipse.sphinx.examples.hummingbird10.impl.ConnectionImpl#getSourceComponent <em>Source Component</em>}</li>
...
public class ConnectionImpl extends ExtendedEObjectImpl implements Connection {
		...
		if (requiredInterface != null && requiredInterface.eIsProxy()) {
			...
			if (requiredInterface != oldRequiredInterface) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Hummingbird10Package.CONNECTION__REQUIRED_INTERFACE, oldRequiredInterface, requiredInterface));
			}
		}
	...
	public void setRequiredInterface(Interface newRequiredInterface) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hummingbird10Package.CONNECTION__REQUIRED_INTERFACE, oldRequiredInterface, requiredInterface));
	}
	...
	public Component getTargetComponent() {
		if (targetComponent != null && targetComponent.eIsProxy()) {
			...
			if (targetComponent != oldTargetComponent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Hummingbird10Package.CONNECTION__TARGET_COMPONENT, oldTargetComponent, targetComponent));
			}
		}
	...
	public NotificationChain basicSetTargetComponent(Component newTargetComponent, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Hummingbird10Package.CONNECTION__TARGET_COMPONENT, oldTargetComponent, newTargetComponent);
	...
	public void setTargetComponent(Component newTargetComponent) {
		if (newTargetComponent != targetComponent) {
			...
			if (targetComponent != null)
				msgs = ((InternalEObject)targetComponent).eInverseRemove(this, Hummingbird10Package.COMPONENT__INCOMING_CONNECTIONS, Component.class, msgs);
			if (newTargetComponent != null)
				msgs = ((InternalEObject)newTargetComponent).eInverseAdd(this, Hummingbird10Package.COMPONENT__INCOMING_CONNECTIONS, Component.class, msgs);
			msgs = basicSetTargetComponent(newTargetComponent, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hummingbird10Package.CONNECTION__TARGET_COMPONENT, newTargetComponent, newTargetComponent));
	}
	...
	public Component getSourceComponent() {
		if (eContainerFeatureID() != Hummingbird10Package.CONNECTION__SOURCE_COMPONENT) return null;
	...
	public void setSourceComponent(Component newSourceComponent) {
		if (newSourceComponent != eInternalContainer() || (eContainerFeatureID() != Hummingbird10Package.CONNECTION__SOURCE_COMPONENT && newSourceComponent != null)) {
			...
			if (newSourceComponent != null)
				msgs = ((InternalEObject)newSourceComponent).eInverseAdd(this, Hummingbird10Package.COMPONENT__OUTGOING_CONNECTIONS, Component.class, msgs);
			msgs = basicSetSourceComponent(newSourceComponent, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hummingbird10Package.CONNECTION__SOURCE_COMPONENT, newSourceComponent, newSourceComponent));
	}
