...
public class Hummingbird10Validator extends EObjectValidator {
	...
	public boolean validateConnection(Connection connection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateConnection_validateInterfacesImplementedByTargetComponent(connection, diagnostics, context);
		return result;
	}
	 ...
	 * @generated
	 */
	public boolean validateConnection_validateInterfacesImplementedByTargetComponent(Connection connection, DiagnosticChain diagnostics, Map<Object, Object> context) {
