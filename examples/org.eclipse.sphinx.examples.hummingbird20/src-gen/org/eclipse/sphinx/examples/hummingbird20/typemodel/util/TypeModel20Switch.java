...
public class TypeModel20Switch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case TypeModel20Package.PLATFORM: {
			...
			if (result == null) {
				result = caseIdentifiable(platform);
			}
			if (result == null) {
		...
		case TypeModel20Package.COMPONENT_TYPE: {
			...
			if (result == null) {
				result = caseIdentifiable(componentType);
			}
			if (result == null) {
				result = defaultCase(theEObject);
			}
		...
		case TypeModel20Package.INTERFACE: {
			...
			if (result == null) {
				result = caseIdentifiable(interface_);
			}
			if (result == null) {
				result = defaultCase(theEObject);
			}
		...
		case TypeModel20Package.PARAMETER: {
			...
			if (result == null) {
				result = caseIdentifiable(parameter);
			}
			if (result == null) {
				result = defaultCase(theEObject);
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Platform</em>'. <!-- begin-user-doc --> This
