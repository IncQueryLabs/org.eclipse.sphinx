 ...
 * <li>{@link org.eclipse.sphinx.examples.hummingbird20.typemodel.impl.PortImpl#getRequiredInterface <em>Required
 * Interface</em>}</li>
 * <li>{@link org.eclipse.sphinx.examples.hummingbird20.typemodel.impl.PortImpl#getMinProviderCount <em>Min Provider
 * Count</em>}</li>
 * <li>{@link org.eclipse.sphinx.examples.hummingbird20.typemodel.impl.PortImpl#getMaxProviderCount <em>Max Provider
 * Count</em>}</li>
 * </ul>
 * </p>
 *
...
public class PortImpl extends IdentifiableImpl implements Port {
	...
	public ComponentType getOwner() {
		if (eContainerFeatureID() != TypeModel20Package.PORT__OWNER) {
			return null;
		}
		...
		if (requiredInterface != null && requiredInterface.eIsProxy()) {
			...
			if (requiredInterface != oldRequiredInterface) {
				if (eNotificationRequired()) {
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TypeModel20Package.PORT__REQUIRED_INTERFACE, oldRequiredInterface,
							requiredInterface));
				}
			}
		}
	...
	public NotificationChain basicSetRequiredInterface(Interface newRequiredInterface, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TypeModel20Package.PORT__REQUIRED_INTERFACE,
	...
	public void setRequiredInterface(Interface newRequiredInterface) {
		if (newRequiredInterface != requiredInterface) {
			...
			if (requiredInterface != null) {
				msgs = ((InternalEObject) requiredInterface).eInverseRemove(this, TypeModel20Package.INTERFACE__REQUIRING_PORTS, Interface.class,
						msgs);
			}
			if (newRequiredInterface != null) {
				msgs = ((InternalEObject) newRequiredInterface).eInverseAdd(this, TypeModel20Package.INTERFACE__REQUIRING_PORTS, Interface.class,
						msgs);
			}
			...
			eNotify(new ENotificationImpl(this, Notification.SET, TypeModel20Package.PORT__REQUIRED_INTERFACE, newRequiredInterface,
					newRequiredInterface));
		}
	}
