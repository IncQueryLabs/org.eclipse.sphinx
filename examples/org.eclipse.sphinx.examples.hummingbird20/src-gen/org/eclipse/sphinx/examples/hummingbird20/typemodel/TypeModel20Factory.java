...
public interface TypeModel20Factory extends EFactory {
	...
	/**
	 * Returns a new object of class '<em>Platform</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Component Type</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
