 ...
 * <ul>
 * <li>{@link org.eclipse.sphinx.examples.hummingbird20.typemodel.Interface#getProvidingComponentTypes <em>Providing
...
public interface Interface extends Identifiable {
	/**
	 * Returns the value of the '<em><b>Providing Component Types</b></em>' reference list. The list contents are of
	 * type {@link org.eclipse.sphinx.examples.hummingbird20.typemodel.ComponentType}. It is bidirectional and its
	 * opposite is '{@link org.eclipse.sphinx.examples.hummingbird20.typemodel.ComponentType#getProvidedInterfaces
	 * <em>Provided Interfaces</em>}'. <!-- begin-user-doc -->
	 * <p>
	...
	/**
	 * Returns the value of the '<em><b>Requiring Ports</b></em>' reference list. The list contents are of type
