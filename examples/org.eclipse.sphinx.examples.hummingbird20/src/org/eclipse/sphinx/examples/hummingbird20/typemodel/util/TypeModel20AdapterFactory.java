...
public class TypeModel20AdapterFactory extends AdapterFactoryImpl {
	 ...
	 * {@link org.eclipse.sphinx.examples.hummingbird20.typemodel.Platform <em>Platform</em>}'. <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.sphinx.examples.hummingbird20.typemodel.Port
	 * <em>Port</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we can easily ignore
	...
	/**
	 * Creates a new adapter for an object of class '
	 * {@link org.eclipse.sphinx.examples.hummingbird20.typemodel.Interface <em>Interface</em>}'. <!-- begin-user-doc
	...
	/**
	 * Creates a new adapter for an object of class '
	 * {@link org.eclipse.sphinx.examples.hummingbird20.typemodel.Parameter <em>Parameter</em>}'. <!-- begin-user-doc
	 * --> This default implementation returns null so that we can easily ignore cases; it's useful to ignore a case
	 * when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	 * @return the new adapter.
	...
	/**
	 * Creates a new adapter for an object of class '
	 * {@link org.eclipse.sphinx.examples.hummingbird20.common.Identifiable <em>Identifiable</em>}'. <!-- begin-user-doc
	 * --> This default implementation returns null so that we can easily ignore cases; it's useful to ignore a case
	 * when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	 * @return the new adapter.
