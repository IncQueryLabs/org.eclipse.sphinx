...
public class ComponentImpl extends IdentifiableImpl implements Component {
	...
	public Connection getIncomingConnections() {
		if (incomingConnections != null && incomingConnections.eIsProxy()) {
			...
			if (incomingConnections != oldIncomingConnections) {
				if (eNotificationRequired()) {
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, InstanceModel20Package.COMPONENT__INCOMING_CONNECTIONS,
							oldIncomingConnections, incomingConnections));
				}
			}
		}
	...
	public NotificationChain basicSetIncomingConnections(Connection newIncomingConnections, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, InstanceModel20Package.COMPONENT__INCOMING_CONNECTIONS,
					oldIncomingConnections, newIncomingConnections);
			if (msgs == null) {
				msgs = notification;
			} else {
	...
	public void setIncomingConnections(Connection newIncomingConnections) {
		if (newIncomingConnections != incomingConnections) {
			...
			if (incomingConnections != null) {
				msgs = ((InternalEObject) incomingConnections).eInverseRemove(this, InstanceModel20Package.CONNECTION__TARGET_COMPONENT,
						Connection.class, msgs);
			}
			if (newIncomingConnections != null) {
				msgs = ((InternalEObject) newIncomingConnections).eInverseAdd(this, InstanceModel20Package.CONNECTION__TARGET_COMPONENT,
						Connection.class, msgs);
			}
			...
			eNotify(new ENotificationImpl(this, Notification.SET, InstanceModel20Package.COMPONENT__INCOMING_CONNECTIONS, newIncomingConnections,
	...
	public EList<ParameterExpresssion> getParameterExpressions() {
		if (parameterExpressions == null) {
			parameterExpressions = new EObjectContainmentEList<ParameterExpresssion>(ParameterExpresssion.class, this,
