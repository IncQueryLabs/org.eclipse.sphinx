...
/**
 * This is the action bar contributor for the TypeModel20 model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TypeModel20ActionBarContributor
	...
	implements ISelectionChangedListener
{
	 ...
	 * @generated
	 */
	public TypeModel20ActionBarContributor()
	{
	...
	{
		toolBarManager.add(new Separator("typemodel20-settings")); //$NON-NLS-1$
		toolBarManager.add(new Separator("typemodel20-additions")); //$NON-NLS-1$
	}
	...
	public void contributeToMenu(IMenuManager menuManager)
	{
		...
		IMenuManager submenuManager = new MenuManager(Activator.INSTANCE.getString("_UI_TypeModel20Editor_menu"), "org.eclipse.sphinx.examples.hummingbird20.typemodelMenuID"); //$NON-NLS-1$ //$NON-NLS-2$
