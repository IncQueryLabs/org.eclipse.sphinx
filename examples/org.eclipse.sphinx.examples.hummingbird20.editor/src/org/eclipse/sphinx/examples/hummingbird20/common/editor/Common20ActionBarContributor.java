...
/**
 * This is the action bar contributor for the Common20 model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class Common20ActionBarContributor
	...
	implements ISelectionChangedListener
{
	 ...
	 * @generated
	 */
	public Common20ActionBarContributor()
	{
	...
	{
		toolBarManager.add(new Separator("common20-settings")); //$NON-NLS-1$
		toolBarManager.add(new Separator("common20-additions")); //$NON-NLS-1$
	}
	...
	public void contributeToMenu(IMenuManager menuManager)
	{
		...
		IMenuManager submenuManager = new MenuManager(Activator.INSTANCE.getString("_UI_Common20Editor_menu"), "org.eclipse.sphinx.examples.hummingbird20.commonMenuID"); //$NON-NLS-1$ //$NON-NLS-2$
