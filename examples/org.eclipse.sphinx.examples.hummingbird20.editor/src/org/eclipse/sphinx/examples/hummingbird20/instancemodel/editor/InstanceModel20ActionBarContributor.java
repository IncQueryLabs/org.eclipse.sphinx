...
/**
 * This is the action bar contributor for the InstanceModel20 model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InstanceModel20ActionBarContributor
	...
	implements ISelectionChangedListener
{
	 ...
	 * @generated
	 */
	public InstanceModel20ActionBarContributor()
	{
	...
	{
		toolBarManager.add(new Separator("instancemodel20-settings")); //$NON-NLS-1$
		toolBarManager.add(new Separator("instancemodel20-additions")); //$NON-NLS-1$
	}
	...
	public void contributeToMenu(IMenuManager menuManager)
	{
		...
		IMenuManager submenuManager = new MenuManager(Activator.INSTANCE.getString("_UI_InstanceModel20Editor_menu"), "org.eclipse.sphinx.examples.hummingbird20.instancemodelMenuID"); //$NON-NLS-1$ //$NON-NLS-2$
