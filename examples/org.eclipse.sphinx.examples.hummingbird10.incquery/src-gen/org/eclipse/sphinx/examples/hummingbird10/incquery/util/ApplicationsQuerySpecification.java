...
public final class ApplicationsQuerySpecification extends BaseGeneratedQuerySpecification<ApplicationsMatcher> {
  ...
  public ApplicationsMatch newMatch(final Object... parameters) {
    return ApplicationsMatch.newMatch((org.eclipse.sphinx.examples.hummingbird10.Application) parameters[0]);
  }
  ...
  public Set<PBody> doGetContainedBodies() throws IncQueryException {
    Set<PBody> bodies = Sets.newLinkedHashSet();
    {
      ...
      new TypeUnary(body, var_app, getClassifierLiteral("http://www.eclipse.org/sphinx/examples/hummingbird/1.0.0", "Application"), "http://www.eclipse.org/sphinx/examples/hummingbird/1.0.0/Application");
      bodies.add(body);
    }
    return bodies;
  }
