...
/**
 * Generated pattern matcher API of the org.eclipse.sphinx.examples.hummingbird10.incquery.applications pattern,
...
public class ApplicationsMatcher extends BaseMatcher<ApplicationsMatch> {
   ...
   */
  @Deprecated
  public DeltaMonitor<ApplicationsMatch> newFilteredDeltaMonitor(final boolean fillAtStart, final Application pApp) {
    return rawNewFilteredDeltaMonitor(fillAtStart, new Object[]{pApp});
  }
  ...
  protected ApplicationsMatch tupleToMatch(final Tuple t) {
    try {
      return ApplicationsMatch.newMatch((org.eclipse.sphinx.examples.hummingbird10.Application) t.get(POSITION_APP));
  ...
  protected ApplicationsMatch arrayToMatch(final Object[] match) {
    try {
      return ApplicationsMatch.newMatch((org.eclipse.sphinx.examples.hummingbird10.Application) match[POSITION_APP]);
    } catch(ClassCastException e) {
  ...
  protected ApplicationsMatch arrayToMatchMutable(final Object[] match) {
    try {
      return ApplicationsMatch.newMutableMatch((org.eclipse.sphinx.examples.hummingbird10.Application) match[POSITION_APP]);
    } catch(ClassCastException e) {
      LOGGER.error("Element(s) in array not properly typed!",e);
      return null;
    }
