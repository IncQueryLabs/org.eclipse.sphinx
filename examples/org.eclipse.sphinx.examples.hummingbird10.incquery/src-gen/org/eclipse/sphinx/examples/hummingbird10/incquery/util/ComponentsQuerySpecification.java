...
public final class ComponentsQuerySpecification extends BaseGeneratedQuerySpecification<ComponentsMatcher> {
  ...
  public String getFullyQualifiedName() {
    return "org.eclipse.sphinx.examples.hummingbird10.incquery.components";
  ...
  public List<PParameter> getParameters() {
    return Arrays.asList(new PParameter("component", "org.eclipse.sphinx.examples.hummingbird10.Component"));
  }
  ...
  public ComponentsMatch newMatch(final Object... parameters) {
    return ComponentsMatch.newMatch((org.eclipse.sphinx.examples.hummingbird10.Component) parameters[0]);
  }
  ...
  public Set<PBody> doGetContainedBodies() throws IncQueryException {
    Set<PBody> bodies = Sets.newLinkedHashSet();
    {
      ...
      new TypeUnary(body, var_component, getClassifierLiteral("http://www.eclipse.org/sphinx/examples/hummingbird/1.0.0", "Component"), "http://www.eclipse.org/sphinx/examples/hummingbird/1.0.0/Component");
      bodies.add(body);
    }
    return bodies;
  }
