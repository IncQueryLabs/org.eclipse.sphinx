...
public final class InterfacesQuerySpecification extends BaseGeneratedQuerySpecification<InterfacesMatcher> {
  ...
  public List<PParameter> getParameters() {
    return Arrays.asList(new PParameter("interface", "org.eclipse.sphinx.examples.hummingbird10.Interface"));
  }
  ...
  public InterfacesMatch newMatch(final Object... parameters) {
    return InterfacesMatch.newMatch((org.eclipse.sphinx.examples.hummingbird10.Interface) parameters[0]);
  }
  ...
  public Set<PBody> doGetContainedBodies() throws IncQueryException {
    Set<PBody> bodies = Sets.newLinkedHashSet();
    {
      ...
      new TypeUnary(body, var_interface, getClassifierLiteral("http://www.eclipse.org/sphinx/examples/hummingbird/1.0.0", "Interface"), "http://www.eclipse.org/sphinx/examples/hummingbird/1.0.0/Interface");
      bodies.add(body);
    }
    return bodies;
  }
