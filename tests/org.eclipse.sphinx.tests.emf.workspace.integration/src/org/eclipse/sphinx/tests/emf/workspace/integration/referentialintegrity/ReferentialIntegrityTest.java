...
public class ReferentialIntegrityTest extends DefaultIntegrationTestCase {
	...
	protected String[] getProjectsToLoad() {
		return new String[] { DefaultTestReferenceWorkspace.HB_PROJECT_NAME_20_A, DefaultTestReferenceWorkspace.HB_PROJECT_NAME_20_D,
				DefaultTestReferenceWorkspace.HB_PROJECT_NAME_20_E, DefaultTestReferenceWorkspace.HB_PROJECT_NAME_10_D,
				DefaultTestReferenceWorkspace.HB_PROJECT_NAME_10_E };
	}
